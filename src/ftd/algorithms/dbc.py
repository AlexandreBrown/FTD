...
class DeterministicTransitionModel(nn.Module):
    ...
    def __init__(self, projection, action_shape, hidden_dim, encoder_max_norm=None):
        super().__init__()
        # self.shared_cnn = shared_cnn
        # self.head_cnn = head_cnn
        # self.projection = projection
...
class BisimAgent(object):
    ...
    def __init__(self, obs_shape, action_shape, args):
        ...
        self.reward_model = RewardModel(
            critic_projection.out_dim, args.hidden_dim
        ).cuda()
        ...
        if self.transition_model_type == "":
            ...
            if self.dyn_loss == "mse":
                ...
                transition_dist = F.smooth_l1_loss(
                    ...
                    pred_next_latent_sigma1, pred_next_latent_sigma2, reduction="none"
                )
